...
tailwind 구성 파일에서 기본 속성을 변경하여 테마 색상을 쉽게 수정할 수 있습니다.
...
기본 색상 속성은 50, 100, 200 ... 900의 키와 해당 색상 코드 값이 있는 개체에 할당되어야 합니다.

Tailwind에는 자신의 웹사이트 테마에 사용할 수 있는 훌륭한 기본 색상 팔레트가 포함되어 있습니다. Check out [customizing colors documentation page](https://tailwindcss.com/docs/customizing-colors) for the full range of options.
